...
cmake -S curl -B build -D CMAKE_BUILD_TYPE=Debug -D BUILD_CURL_EXE=OFF -D BUILD_EXAMPLES=OFF -D BUILD_LIBCURL_DOCS=OFF -D BUILD_MISC_DOCS=OFF -D BUILD_TESTING=OFF -D CURL_ENABLE_SSL=ON -D ENABLE_CURL_MANUAL=OFF -D PICKY_COMPILER=OFF
